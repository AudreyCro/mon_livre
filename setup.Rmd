...
https://github.com/AudreyCro/mon_livre.git
...
9. Type git remote add mon_livre https://github.com/AudreyCro/mon_livre.git
...
ATTENTION : Ne pas oublier de renommer le fichier page_maitresse.Rmd en index.Rmd ainsi que tous les endroits où il est cité (yml).
